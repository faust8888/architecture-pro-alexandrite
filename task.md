...
Вот схема текущей архитектуры в модели C4: /resource/jewerly_c4_model.drawio
...
В архиве /resource/architecture-alexandrite-k8s-trace-main.zip находятся подготовленные DevOps специалистом конфигурации для запуска Jaeger в папке k8s.
